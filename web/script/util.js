...
function login(){
    ...
    alert("Test-User -> Felder leer lassen")
}
...
function index_projectList(number){
    ...
    ProjectJson(function(projects) {
        ...
        let  list = document.getElementById("projectList");
        for(let i=projects.length; i>=0 && i>=projects.length-number; i--){
...
function showProject(){
    ...
    //let json = ProjectJsonById(id)
   // console.log(json)
    
    /*let project = */ProjectJsonById(id, function(project) {
        /*
            if(!project){
        ...
        console.log("Comments of Project", project.comments);
        for(let id of project.comments){
            console.log("comment_is "+id);
            CommentJsonById(id, function(object){
                let h4 = document.createElement("h4");
                let stars = document.createElement("h5");
                let text = document.createElement("p");
                UserJsonById(object.user, function(user_obj) {
